    ...
    return(
        <div className="bg-[#F3E8FF] h-screen">
            ...
            <div className="flex space-x-4 p-9 justify-between">
                ...
                <div className="cursor-pointer w-90 h-110 bg-[#E5D4FF]" onClick={() => navigate("/hub")}>
                ...
                <div className="cursor-pointer w-90 h-110 bg-[#E5D4FF]" onClick={() => navigate("/resources")}>
